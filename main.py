...
class PT1App(App):
    def build(self):
        sm = ScreenManager()
        for s in [AccountScreen(name='account'), CharSelectScreen(name='char_select'), 
